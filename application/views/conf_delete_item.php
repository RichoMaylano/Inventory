        ...
        <div class="pcoded-content">
            ...
            <!-- admin_home -->
                    <div class="col-sm-12">
                                ...
                                <form class="user">
                                <div class="text-center">
                      <h1 class="h4 text-gray-900 mb-4">Apakah anda yakin ingin menghapus <?php echo $user->nama_barang ?>?</h1>
                      </div>
                      <div class="text">
                       <div class="form-group row">
                                                <div class="col-sm-6 mb-3 mb-sm-0">
                                                <a href="delete_item_x?id=<?php echo htmlspecialchars($user->id)?>"" class="btn btn-success btn-user btn-block ">Ya</a>
                                                </div>
                                            <div class="col-sm-6">
                                            <a href="admin_home#inventory" class="btn btn-danger btn-user btn-block ">Tidak</a></div>
                                                </div>
                                                </div>
                                                </form>    
