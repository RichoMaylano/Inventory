                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="card " id="layouts">
                                    ...
                                    <div class="card-body">
                                        <form class="user" <?php echo form_open('auth/pakai_item_proses_user'); ?> <?php echo $this->session->flashdata('message7'); ?> <hr>
                                            <b>ID Barang :</b>
                                            ...
                                            <div class="form-group">
                                                <input type="number" min="0" placeholder="Masukkan Jumlah Penggunaan" class="form-control form-control-user" name="jumlah" id="jumlah" required autofocus />
                                            </div>
