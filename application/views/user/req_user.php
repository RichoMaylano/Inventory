    ...
    <div class="navbar-wrapper">
        <div class="navbar-content scroll-div">
            <ul class="nav pcoded-inner-navbar">
                ...
                <li class="nav-item"><a href="home" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Dashboard</span></a></li>

                <li class="nav-item pcoded-menu-caption">
                    <label>Menu</label>
                </li>
                <li class="nav-item"><a href="home" class="nav-link "><span class="pcoded-micon"><i class="feather icon-package"></i></span><span class="pcoded-mtext">Inventory</span></a></li>
                ...
                <li class="nav-item pcoded-hasmenu">
                    ...
                    <ul class="pcoded-submenu">
                        <li><a href="home">User List</a></li>
                        <li><a href="home">Admin List</a></li>
                    </ul>
                </li>
                                ...
                                <div class="card " id="layouts">
                                    <div class="card-header bg-gradient-danger">
                                        <div class="text-center">
                                            <h5>
                                                <font color="white">Request User</font>
                                            </h5>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <form class="user" <?php echo form_open('auth/req_user_proses'); ?> <?php echo $this->session->flashdata('message8'); ?> <hr>
                                            <b>ID Barang :</b>
                                            ...
                                            <b>Jumlah Request :</b>
                                            <div class="form-group">
                                                <input type="number" min="1" placeholder="Masukkan Jumlah Request" class="form-control form-control-user" name="jumlah" id="jumlah" required autofocus />
                                            </div>
                                            ...
                                            <div class="edit-button">
                                                <div class="form-group row">
                                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                                        <button type="submit" class="btn btn-warning btn-user btn-block">Request</button>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <a href="home#inventory" class="btn btn-dark btn-user btn-block">Cancel</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <br>
