                                ...
                                <div class="card " id="layouts">
                                    <div class="card-header bg-gradient-danger">
                                        <div class="text-center">
                                            <h5>
                                                <font color="white">Edit Item</font>
                                            </h5>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <form class="user" <?php echo form_open('auth/edit_item_proses'); ?> <?php echo $this->session->flashdata('message'); ?> 
                                        <hr>
                                            <b>Kuantitas :</b>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp <b>Tersedia :</b>
                                            <div class="form-group row">
                                                <div class="col-sm-6 mb-3 mb-sm-0">
                                                    <input type="text" placeholder="Kapasitas Barang" class="form-control form-control-user" value="<?php echo htmlspecialchars($item->kuantitas) ?>" name="kuantitas" id="kuantitas" required autofocus />
                                                </div>
                                                <div class="col-sm-6">
                                                    <input type="text" placeholder="Kapasitas Barang tersedia" class="form-control form-control-user" value="<?php echo htmlspecialchars($item->tersedia) ?>" name="available" id="available" required autofocus />
                                                </div>
                                            </div>

                                            <b>ID Barang :</b>
                                            <div class="form-group">
                                                <input type="text" placeholder="Masukkan ID Barang" class="form-control form-control-user" value="<?php echo htmlspecialchars($item->id_barang) ?>" name="id_barang" id="id_barang" required autofocus />
                                            </div>


                                            <b>Nama Barang :</b>
                                            <div class="form-group">
                                                <input type="text" placeholder="Masukkan Nama Barang" class="form-control form-control-user" value="<?php echo htmlspecialchars($item->nama_barang) ?>" name="nama" id="nama" required autofocus />
                                            </div>


                                            <b>Lokasi Penyimpanan :</b>
                                            <div class="form-group">
                                                <input type="text" placeholder="Masukkan Lokasi Penyimpanan" class="form-control form-control-user" value="<?php echo htmlspecialchars($item->lokasi) ?>" name="lokasi" id="lokasi" required autofocus />
                                            </div>
                                            ...
                                            <div class="edit-button">
                                                <div class="form-group row">
                                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                                        <button type="submit" class="btn btn-warning btn-user btn-block">Save</button>
                                                    </div>
                                                    <div class="col-sm-6">
