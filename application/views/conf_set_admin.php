                    ...
                    <div class="col-sm-12">
                                <div class="card " id="layouts">
                                    ...
                                    <div class="text-center">
                                        <h5><font color="white">Konfirmasi Set Admin</font></h5>
                                        </div>
                                    </div>
                                <div class="card-body">      
                                <form class="user">
                                <div class="text-center">
                      <h1 class="h4 text-gray-900 mb-4">Apakah anda yakin ingin menjadikan <?php echo $user->username ?> Sebagai Admin?</h1>
                       </div>
                       <div class="text">
                       <div class="form-group row">
                                                <div class="col-sm-6 mb-3 mb-sm-0">
                                                <a href="set_admin_x?id=<?php echo htmlspecialchars($user->id)?>"" class="btn btn-success btn-user btn-block ">Ya</a>
                                                </div>
                                            <div class="col-sm-6">
